 ...
 *            item type
 */
public final class DiffListClassic<T> implements DiffList<T> {
	 ...
	 *            object comparator
	 */
	public DiffListClassic(final List<T> left, final List<T> right, final BiPredicate<T, T> comparator) {
		this.left = left;
		this.right = right;
	...
	public String toString() {
		return "DiffListClassic [left=" + left + ", right=" + right + ", comparator=" + comparator + ", lcsLengths="
